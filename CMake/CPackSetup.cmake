...
set(CPACK_PACKAGE_VENDOR "OpenDDR")
...
set(CPACK_NSIS_HELP_LINK "https://github.com/h-lunah/stepmania-ddr/issues")
set(CPACK_NSIS_PACKAGE_NAME "${SM_EXE_NAME} ${NSIS_VERSION_FINAL}")
set(CPACK_NSIS_URL_INFO_ABOUT "about:blank")
...
set(CPACK_PACKAGE_EXECUTABLES "${SM_EXE_NAME}" "OpenDDR")
...
set(CPACK_SM_NSIS_REPOSITORY "https://github.com/h-lunah/stepmania-ddr")
set(CPACK_SM_NSIS_ROOT_DIR "${SM_ROOT_DIR}")
set(CPACK_SM_NSIS_PRODUCT_ID
    "OpenDDR ${SM_VERSION_MAJOR}.${SM_VERSION_MINOR}")
...
if(WIN32)
  ...
  set(CPACK_PACKAGE_INSTALL_DIRECTORY "OpenDDR")
  set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "OpenDDR")
